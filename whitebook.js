...
const main_philidor = [
	{move: "Be7", freq:  92038,book:[{move: "Bf4",replies:[
		{move: "O-O", freq:  4458,book:[{move: "Qd2",replies:[
			...
			{move: "a6", freq: 297,book:[{move: "O-O-O"}]},
			{move: "Nc6", freq:281,book:[{move: "O-O-O"}]},
		]}]},
...
const fork_nights = {move: "Nc3",replies:[
	...
	{move: "Bc5", freq:   833235,book:[{move: "Nxe5",replies:[
		{move: "Nxe5",  freq:  77143,book:[{move: "d4",replies:[
			...
			{move: "Bd6",    freq:  19593,book:[{move: "dxe5"}]},
...
const philidor = [//philidor defence
	{move: "exd4", freq:666899,book:[{move: "Nxd4",replies:[
		...
		{move: "c5", freq:   81720,book:[{move: "Ne2",stock:1.08,replies:[
			...
			{move: "Nf6", freq:  685,book:[{move: "Nb1c3"}]},
	...
	{move: "Bg4", freq: 211540,book:[{move: "Nc3",replies:[
		{move: "Bxf3", freq: 4087,book:[{move: "gxf3",replies:[
			{move: "exd4", freq: 2371,book:[{move: "Qxd4"}]},
...
const french_queen_a3 = [{move: "a3",replies:[
	...
	{move: "a5", freq:  28423,master:227,book:[{move: "Bd3"}]},
	...
	{move: "c3",replies:[
		...
		{move: "d6",  freq:  149838,master:2650,book:[{move: "d4",replies:[
			{move: "cxd4",  freq: 107790,book:[{move: "cxd4",replies:[
				{move: "Nf6",  freq: 48489,book:[{move: "Nc3",replies:[
					{move: "g6",  freq: 10338,book:[{move: "Nf3",replies:[
						{move: "Bg7",  freq:  32125,book:[{move: "Bb5+",replies:[
							{move: "Bd7",  freq:  4072,book:[{move: "e5",replies:[
								...
								{move: "Bxb5",  freq: 135,book:[{move: "exf6"}]},
								{move: "Ng4",   freq:  83},
								{move: "Ng8",   freq:  51},
								{move: "Nh5",   freq:  28},
							]}]},
					...
					{move: "e6",  freq:  8073,stock:1.31,book:[{move: "Nf3"}]},
					{move: "a6",  freq:  6896,book:[{move: "Nf3"}]},
				...
				{move: "g6",  freq:  10442,book:[{move: "Nc3"}]},
		...
		{move: "d5",  freq:   71256,master:11225,book:[{move: "exd5",replies:[
			{move: "Qxd5",  freq:  37488,book:[{move: "Nf3",replies:[
				...
				{move: "Nc6",  freq: 3102,book:[{move: "d4",replies:[
					{move: "Bg4",  freq:  71139,book:[{move: "Be2"}]},
		...
		{move: "Nf6",  freq:  43999,master:14472,book:[{move: "e5",replies:[
			{move: "Nd5",  freq:  25187,book:[{move: "Nf3",replies:[
				{move: "Nc6",  freq: 1369,book:[{move: "Bc4",stock:0.00,replies:[
					{move: "Nb6",  freq:  18151,book:[{move: "Bb3"}]},
					{move: "e6",   freq:   5228},
					{move: "Nc7",  freq:    511},
				]}]},
				{move: "e6",  freq:   953},
...
const lolli_attack = {move: "d4",replies:[
	...
	{move: "Be7",  freq:1398,book:[{move: "Nxf7",replies:[
		{move: "Kxf7",   freq:  125587,book:[{move: "Qf3+",replies:[
			...
			{move: "Ke6",   freq:  573,book:[{move: "Nc3"}]},
...
const italian = {move: "Bc4",replies:[
	...
	{move: "h6",   freq: 1051935,book:[{move: "d4",replies:[//anti fried liver
		{move: "exd4", freq: 192921,book:[{move: "Nxd4",replies:[
			...
			{move: "Bc5", freq:  26475,book:[{move: "Bxf7+",stock:3.59,replies:[
				{move: "Kxf7", freq:  2717,book:[{move: "Qh5+",replies:[
					{move: "g6", freq: 1531,book:[{move: "Qxc5"}]},
			...
			{move: "d6", freq:    8904,book:[{move: "O-O"}]},
		]}]},
	...
	{move: "g6", freq:    18616,book:[{move: "d4"}]},
...
const hoh_kingKnight = 
	{move: "Nf3",replies:[
		...
		{move: "Nf6", freq: 2227800,master:26105,book:[modern_attack,classical_attack,russian_nights]},
	...
	{move: "d5", freq: 1708932,book:[
		{move: "e5",replies:[
				...
				{move: "e6",   freq: 2780,book:[{move: "Nb3",replies:[
					{move: "Nd7",   freq: 9266,book:[{move:"Ne2",replies:[
						...
						{move: "h6",   freq:  14,book:[{move: "Ng3",replies:[
							{move: "Bh7",   freq:  14,book:[{move: "Be2"}]},
							{move: "Bg6",   freq:   3},
							{move: "Ne7",   freq:   2},
						]}]},
					]},{move: "Nf3",replies:[
			...
			{move: "c5",   freq:  111809,book:[{move: "Nf3",replies:[
				...
				{move: "cxd4",   freq:   25140,book:[{move: "Nxd4"}]},
				{move: "e6",    freq:    5390,book:[{move: "c3",stock:0.76}]},//lmao, delayed french
			]}]},
			{move: "e6",   freq:   68029,book:[{move: "c3",replies:[
				{move: "c5",   freq: 6129,book:[{move: "Nf3",replies:[
					{move: "Nc6",  freq: 55174,book:[{move: "Bd3",replies:[
						{move: "Qb6",   freq:  5834},
					]}]},
					{move: "cxd4", freq: 27953,book:[{move: "cxd4"}]},
					{move: "c4",   freq:  6908},
					{move: "Qb6",  freq:  3974},	
				]}]},
				{move: "Ne7",  freq: 1708},
...
const owen_e6 = {move: "Bd3",replies:[
	...
	{move: "Nf6", freq:    9224,stock:1.20,book:[{move: "Ng1e2"}]},
	{move: "d5", freq:     2761},
]}
			...
			{move: "Nf6", freq: 188121,book:[{move: "Ne2",replies:[
				...
				{move: "d6", freq:   5923,book:[{move: "Nb1c3",replies:[
					{move: "Bg4", freq: 621,book:[{move: "Qe3",replies:[
						{move: "Bxe2", freq: 57,book:[{move: "Nxe2"}]},
...
const modern_d6 = {move: "f4",replies:[
	{move: "Nf6", freq: 88220,book:[{move: "Nf3",replies:pirc_d6_modern}]},
	{move: "a6", freq:  37388,book:[{move: "Nf3"}]},
	{move: "Nc6", freq: 34793,book:[{move: "Be3"}]},
	{move: "Nd7", freq: 21809,book:[{move: "Nf3"}]},
	{move: "c6", freq:  17583,book:[{move: "Nf3"}]},
	{move: "e6", freq:   9853,book:[{move: "Nf3"}]},
]}

const modern = {move: "d4",replies:[//modern
	{move: "Bg7", freq: 1126123,book:[{move: "Nc3",replies:[
		{move: "d6", freq: 71077,book:[modern_d6]},
		...
		{move: "c5", freq: 12791},
		{move: "c6", freq: 10662,book:[{move: "f4"}]},
	]}]},
...
const whiteBook = {
	book: [
		{move: "e4",
			replies: [
				{move: "e5",freq: 33121744,master:244654,book:[hoh_kingKnight,wayward,hohVienna]},
				...
				{move: "e6",freq: 8895904,master:134130,book:[{move: "d4",replies:[
					...
					{move: "c6",  freq:  187958,book:[{move: "Bd3",replies:[
						{move: "d5", freq:   20504,book:[{move: "Nc3"}]},
				...
				{move: "g6",freq: 2753427,master:32190,book:[modern]},
				...
				{move: "b6",freq: 1805399,book:[owen]},//owen
				{move: "Nf6",freq: 1445137,book:[alekhine]},//alekhine
				{move: "Nc6",freq: 1204761,master:19927,book:[{move: "d4",replies:[//nimzo
