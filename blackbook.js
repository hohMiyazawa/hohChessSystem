...
const danish = {move:"exd4",replies:[
	...
	{move: "Qxd4", freq:  873247,book:[{move:"Nc6",replies:[
		{move: "Qe3",  freq:  353419,book:[{move:"Nf6"}]},
...
const four_knights = [
			...
			{move: "Nxe4", freq: 105098,book:[{move:"d5",replies:[
				{move: "Ne4g5+", freq: 41492,book:[{move:"Kg8",replies:[
					{move: "d3", freq:  16596,book:[{move:"h6",replies:[
						{move: "Nh3", freq:  13769,book:[{move:"Bd6"}]},
					]}]},
				...
				{move: "Ng3", freq:    27962,book:[{move:"e4"}]},
	...
	{move: "d4",   freq: 728826,book:[{move:"exd4",replies:[
		{move: "Nxd4", freq:   561284,book:[{move:"Bb4",replies:[
			{move: "Nxc6", freq: 288120,book:[{move:"bxc6",replies:[
	...
	{move: "Bb5", freq:  650125,book:[{move:"Bb4",replies:[
		...
		{move: "d3", freq:   35507,book:[{move:"Nd4",replies:[
			{move: "Bc4", freq:  1918,book:[{move:"d5"}]},
	...
	{move: "d3", freq:   183536,book:[{move:"Bb4",replies:[
		{move: "Bd2", freq:  61223,book:[{move:"d5"}]},
		{move: "Bg5", freq:  17609},
		{move: "Be2", freq:  16447},
		{move: "a3",  freq:   7926},
		{move: "Be3",  freq:  5135},
...
const bish_rus = {move:"d5",replies:[
	{move: "Bb3", freq:  34153,book:[{move:"Qg5",replies:[
		{move: "O-O", freq:  1982,book:[{move:"Qxe5"}]},
		{move: "d4",  freq:  1402,book:[{move:"Qxg2"}]},
	...
	{move: "Qf3", freq:  29702,book:[{move:"Be6",replies:[
		{move: "Bb3", freq:   5819,book:[{move:"Qg5"}]},
		{move: "Bd3", freq:   3134},
		{move: "Bb5+", freq:  2226},
		{move: "d3",  freq:   2011},
		{move: "O-O", freq:   1077},
	]}]},
	{move: "Bd3", freq:   8644,book:[{move:"Qg5"}]},
	{move: "Nxf7", freq:  8288,book:[{move:"Qe7"}]},
	{move: "Qe2", freq:   5423},
	{move: "Bb5+", freq:  4574},
	{move: "Be2", freq:   3611},
	{move: "Qh5", freq:   2391},
...
const damiano_russian = {move: "Nxe4",replies:[
	{move: "Qe2", freq:  104278,book:[{move:"Qe7",replies:[
		{move: "Qxe4",   freq: 43143,book:[{move:"d6",replies:[
			{move: "d4",     freq:  30593,book:[{move:"dxe5",replies:[
				...
				{move: "Qxe5",    freq:  13146,book:[{move:"Qxe5+",replies:[
					{move: "dxe5",    freq:  10751,book:[{move:"Bf5",replies:[
						...
						{move: "c3",    freq:  1368,book:[{move:"Nd7"}]},
			...
			{move: "Qa4+",   freq:   3370,book:[{move:"Bd7",replies:[
				{move: "Qe4",    freq:  770,book:[{move:"Nc6"}]},
				{move: "Qb3",    freq:  768,book:[{move:"Qxe5+"}]},
				{move: "Qb4",    freq:  272,book:[{move:"Nc6"}]},
				{move: "Qxd7+",  freq:  269,book:[{move:"Nxd7"}]},
				{move: "Bb5",    freq:  246,book:[{move:"Qxe5+"}]},
				{move: "Qd4",    freq:   68},
			]}]},
			{move: "Bb5+",   freq:   2259,book:[{move:"c6"}]},
			{move: "Nc3",    freq:   1548,book:[{move:"Qxe5",replies:[
				{move: "Qxe5+",    freq:   566,book:[{move:"dxe5"}]},
				{move: "d4",       freq:    97},
				{move: "Bc4",      freq:    77},
				{move: "d3",       freq:    12},
				{move: "Bb5+",     freq:    12},
			]}]},
			{move: "f4",     freq:   1438,book:[{move:"f5",replies:[
				{move: "Qe3",    freq:  54,book:[{move:"dxe5",replies:[
					{move: "fxe5",    freq:  27,book:[{move:"Nc6"}]},
		...
		{move: "d4",     freq:  3867,book:[{move:"d5"}]},
	...
	{move: "Nf3",  freq:   7481,book:[{move:"d5"}]},
...
const russian = {move:"Nf6",replies:[
	{move: "Nxe5",freq:1826515,book:[damiano_russian,{move:"d6",replies:[
	...
	{move: "Bc4",freq:  914037,book:[{move:"Nxe4",replies:[
		...
		{move: "Qe2", freq:    61500,book:[{move:"d5",replies:[
			{move: "Bb3",    freq:  22319,book:[{move:"Nc6"}]},
			{move: "Nxe5",   freq:  13197},
			{move: "d3",     freq:   5817},
			{move: "Bd3",    freq:   5619},
			{move: "Bb5+",   freq:   3368},
			{move: "O-O",    freq:   1002},
		...
		{move: "d3",  freq:    41869,book:[{move:"Nc5",replies:[
			{move: "Nxe5",   freq:  1403,book:[{move:"d5"}]},
			{move: "O-O",    freq:   306},
			{move: "Ng5",    freq:   281},
			{move: "Nc3",    freq:   128},
		]}]},
		{move: "Nc3", freq:    36888,book:[{move:"Nxc3",replies:[
			{move: "dxc3",    freq:  24897,book:[{move:"f6"}]},
			{move: "bxc3",    freq:    989},
		]}]},
		{move: "Bxf7+", freq:  21756},
		{move: "d4",    freq:  15970},
		{move: "c3",    freq:   1819},
	]}]},
	{move: "d4",freq:   423568,book:[{move:"Nxe4",replies:[
	...
	{move: "d3",freq:   335543,book:[{move:"Nc6",replies:[
		...
		{move: "Nc3",     freq:   77860,book:[{move:"d5"}]},
		{move: "Bg5",     freq:   69835,book:[{move:"d5"}]},
		{move: "c3",      freq:   41657},
		{move: "g3",      freq:   40150},
		{move: "h3",      freq:   19589},
		{move: "Nb1d2",   freq:   16144},
		{move: "c4",      freq:   15124},
		{move: "Be3",     freq:   13725},
		{move: "a3",      freq:   10339},
	]}]},
...
const regular = {move: "e5",replies:[
	...
	{move: "Bc4", freq:  6438338,book:[{move:"Nf6",replies:[
		{move: "d3",  freq:  965935,book:[{move:"c6",replies:[
			{move: "Nf3",   freq: 35274,book:[{move:"Be7",replies:[
				{move: "O-O",   freq: 1508,book:[{move:"Qa5+"}]},
				{move: "Nxe5",  freq: 1219,book:[{move:"Qc7"}]},
				{move: "Nc3",   freq:  331},
			]}]},
			{move: "Bg5",   freq: 22802},
			{move: "Nc3",   freq: 18197},
		...
		{move: "Nc3",  freq: 489622,book:[{move:"Bc5",replies:[
			{move: "d3",   freq: 147398,book:[{move:"a5"}]},
			{move: "Nf3",  freq: 104638,book:[{move:"d6"}]},
			{move: "h3",   freq:  40732,book:[{move:"O-O"}]},
			{move: "f4",   freq:  15674},
			{move: "Ng1e2",freq:  11012},
		]}]},
		{move: "d4",   freq: 237753,book:[{move:"exd4"}]},
		{move: "Qf3",   freq:138784,book:[{move:"c6"}]},
	...
	{move: "d3", freq:   1293745,book:[{move:"Nc6",replies:[
		{move: "Nf3",   freq:  168375,book:[{move:"Nf6"}]},
...
const london_georg_continues = {move:"Nf6",replies:[
	...
	{move: "Bd3",     freq:  1486,book:[{move:"Nh5"}]},
	{move: "Be2",     freq:  1124,book:[{move:"e6"}]},
	{move: "c4",      freq:   989,book:[{move:"Nh5"}]	},
	{move: "c3",      freq:   831},
	{move: "a4",      freq:   828},
	{move: "h3",      freq:   616},
]}
...
const qg_d4c4Nf = {move: "Bg7",replies:[
	{move: "cxb5",  freq:  1842,book:[{move:"axb5"}]},
	{move: "e3",    freq:   911,book:[{move:"bxc4",replies:[
		{move: "Bxc4",   freq:  3630,book:[{move:"e6"}]},
		{move: "Nc3",    freq:    69,book:[]},
	]}]},
	{move: "Nc3",   freq:   533,book:[]},
	{move: "c5",    freq:   363,book:[]},
	{move: "e4",    freq:   247,book:[]},
]}

const queen_georg = {move: "a6",replies:[
	{move: "c4",   freq:  78746,book:[{move:"b5",replies:[
		{move: "cxb5",   freq:  12029,book:[{move:"axb5",replies:[
			...
			{move: "e3",    freq:  2149,book:[{move:"b4"}]},
		...
		{move: "Nc3",    freq:   8439,book:[{move:"b4",replies:[
			{move: "Ne4",   freq:   1387,book:[{move:"a5"}]},
		...
		{move: "g3",     freq: 5708,book:[{move:"Bb7",replies:[
			{move: "Bg2",    freq: 6483,book:[{move:"e6",replies:[
				{move: "O-O",     freq:  3200,book:[{move:"Nf6",replies:[
					...
					{move: "b3",     freq:   560,book:[]},
					{move: "b3",     freq:   512,book:[]},
					{move: "b3",     freq:   448,book:[]},
				]}]},
...
const accepted = {move: "dxc4",replies:[
	...
	{move: "e3",  freq:    878954,book:[{move:"e5"}]},
...
const blackBook = {
	replies:[
		...
		{move: "g3",  freq:   9688918,book:[{move: "h6",replies:[
		...
		{move: "d3",  freq:   4902794,book:[{move: "d5",replies:[
			...
			{move: "Nf3",  freq:  213700},
			{move: "Nd2",  freq:  170496},
			{move: "e3",  freq:   162083},
			{move: "g3",  freq:   129353},
			{move: "c3",  freq:   109697},
			{move: "Bd2",  freq:   56007},
